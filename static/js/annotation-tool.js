...
function uploadMaskToServer(dataset) {
    ...
    const uploadCallback = function(parsed_json) {
        ...
        const roi_name = parsed_json.roi.roiId;

        // add that roi image to either the training or testing set:
        let xhr_add_to_traintest = new XMLHttpRequest();
        let url_add_to_traintest = add_roi_to_traintestUrl;

        console.log(url_add_to_traintest)
        url_add_to_traintest = url_add_to_traintest.replace("!!!!!", roi_name)
        url_add_to_traintest = url_add_to_traintest.replace("#####", dataset)
        console.log(url_add_to_traintest)
        xhr_add_to_traintest.open('GET', url_add_to_traintest , true);
